...
var flsrc = ["Delhi", "Kolkata", "Mumbai", "Chennai", "Goa", "Cochin", "Pune", "Assam", "Jaipur", "Ankara"];
...
$(document).ready(function() {
  ...
  for (var i = 0; i <= flsrno.length; i++) {
    ...
    $(".flightNo" + (i + 1) + ".flprc").text("TL" + prices[i]);
    
    $(".flightNo" + (i + 1) + ".srno").hide();
    $(".flightNo" + (i + 1) + ".flno").hide();
    $(".flightNo" + (i + 1) + ".flnm").hide();
    $(".flightNo" + (i + 1) + ".flsrc").hide();
    $(".flightNo" + (i + 1) + ".fldst").hide();
    $(".flightNo" + (i + 1) + ".flprc").hide();

    $(".flightNo" + (i + 1) + ".flno").parent().parent().hide();  

  }
  
  const values = JSON.parse(localStorage.getItem("formValueObj"));

  for (var i = 0; i < flsrc.length; i++) {
    if(values.flyingFrom == flsrc[i]){
      $(".flightNo" + (i + 1) + ".srno").show();
      $(".flightNo" + (i + 1) + ".flno").show();
      $(".flightNo" + (i + 1) + ".flnm").show();
      $(".flightNo" + (i + 1) + ".flsrc").show();
      $(".flightNo" + (i + 1) + ".fldst").show();
      $(".flightNo" + (i + 1) + ".flprc").show();

      $(".flightNo" + (i + 1) + ".flsrc").text(values.flyingFrom);
      $(".flightNo" + (i + 1) + ".fldst").text(values.flyingTo);


      $(".flightNo" + (i + 1) + ".flno").parent().parent().show();
